...
1. Hardware: Utilizamos um microcontrolador da família esp-32, um sensor de vazão YS-103 e um móduto RTC  (Real Time Clocking).
2. Inteligência Artificial: O sistema utilza uma rede neuaral para prever o estágio da vazão da água na tubulação.
3. Interface: O projeto apresenta uma interface para alertar e interação com o usuário
